# Name: Casey Lowe
# OSU Email: casey.bellew.lowe@gmail.com
# Course: CS261 - Data Structures
# Assignment: Assignment #5 - Min Heap Implementation
# Due Date: November 30th, 2023
# Description: Implementing the following methods into Min_Heap file: is_empty(), add(), get_min(), remove_min(),
# build_heap(), size(), clear(), and heapsort()
...
def heapsort(da: DynamicArray) -> None:
    ...
    for index in range(n // 2 - 1, -1, -1):
        _percolate_down(da, index, n)

    # sort
    for index in range(n - 1, 0, -1):
        # Swap the smallest element with last element.
        da[index], da[0] = da[0], da[index]
        _percolate_down(da, 0, index)
