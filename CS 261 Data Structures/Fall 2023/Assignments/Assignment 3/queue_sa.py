...
# Description: Implementing Queue ADT class that utilizes a circular buffer by implementing the following
# methods: enqueue() dequeue() front() _increment() _double_queue()
...
class Queue:
    ...
    def front(self) -> object:
        ...
        """
        # Return value front of the queue while checking for queue being empty.
        if self.is_empty() is True:
            raise QueueException
