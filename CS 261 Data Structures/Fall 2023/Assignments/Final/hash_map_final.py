        ...
        for bucket in self._buckets:
            ...
            if bucket.head is not None:
                ...
                while current_node is not None:
                    # Calculate the index for each key in the temporary hashMap
                    index = temp._hash_function(current_node.key) % capacity
                    # Insert the key-value pair into the temporary hashMap
                    temp._buckets[index].add_front(current_node.key, current_node.value)
                    current_node = current_node.next

        # Update the existing hashMap to point to the temporary hashMap
        self._buckets = temp._buckets
        # Change the capacity as well
        self.capacity = capacity
